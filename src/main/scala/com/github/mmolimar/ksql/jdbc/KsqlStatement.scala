...
class KsqlStatement extends Statement{
  ...
  override def execute(sql: String): Boolean = throw NotSupported()

  override def execute(sql: String, autoGeneratedKeys: Int): Boolean = throw NotSupported()

  override def execute(sql: String, columnIndexes: Array[Int]): Boolean = throw NotSupported()

  override def execute(sql: String, columnNames: Array[String]): Boolean = throw NotSupported()

  override def executeQuery(sql: String): ResultSet = throw NotSupported()
